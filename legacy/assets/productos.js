/* ==========================================================================
   ...
   precio: null  →  la web muestra "[ PRECIO POR CONFIRMAR ]" y el producto
                    se pide igual, como cotización por WhatsApp.
   Confirmados con las redes: bidón S/30 y 2 bidones S/50. El resto, pendiente.
   ========================================================================== */
window.VF_TELEFONO = '51994647840';

window.VF_CATEGORIAS = [
