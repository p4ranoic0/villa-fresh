...
/* --------------------------------------------------------------------------
   ...
   Estas NO se dibujan a mano: son los trazados oficiales de Simple Icons
   (CC0). Un icono de línea aproximando un logotipo conocido no se lee como la
   marca, se lee como un dibujo genérico, y era parte de por qué la página no
   parecía real.

   Van rellenas y no en trazo, al revés que los iconos propios, así que usan
   `.marca-ico`.
   -------------------------------------------------------------------------- */

export function IconoWhatsApp() {
  return (
    <svg className="marca-ico" viewBox="0 0 24 24" role="img" aria-label="WhatsApp">
...
export function IconoFacebook() {
  return (
    <svg className="marca-ico" viewBox="0 0 24 24" role="img" aria-label="Facebook">
...
export function IconoInstagram() {
  return (
    <svg className="marca-ico" viewBox="0 0 24 24" role="img" aria-label="Instagram">
